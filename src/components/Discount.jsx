  ...
  return (
    <section className='text-center mt-20 w-[80%] mx-auto'>
        ...
        <div className='flex items-center gap-2 mt-14'>
          <input type="text" placeholder='Địa chỉ email của bạn' className='border-b-4 border-blackText outline-none flex-[5] text-[14px]  text-grayText font-medium self-end' />
